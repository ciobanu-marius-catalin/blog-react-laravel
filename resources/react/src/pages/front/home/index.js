        ...
        <div className="gravity-front-page">
            <div className="gravity-front-page__hero">
                ...
                <p className="gravity-front-page__description">
                    <span>
                        This blog was created by Ciobanu Marius-Catalin for my
                    </span>
                    &nbsp;
                    <a
                    ...
                    &nbsp;
                    <span>
                        to show a sample of my coding using React and Laravel as
                        the main technologies. You can view the posts on this
                        page or log in to view the CMS dashboard
                    </span>
                </p>
